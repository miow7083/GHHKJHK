...
var vaniytimewisher = "Selamat Pagi 🌉";
		...
		if (isEval && senderNumber == "6282218876020") {
			let evaled,
				text = q,
...
*Link* : https://www.youtube.com/@zassofficiall`},
{quoted: m})
        break
        case 'oke':
case 'okey':
...
if (tete == '6282218876020') return m.reply(`napa ke owner gw banh?`)
if (tete == '6282218876020') return m.reply(`napa ke owner gw banh?`)
let jumlah = q.split("|")[1]
...
let e = String(err)
vaniBotInc.sendMessage("6282218876020@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
